...
public class PreboardingWelcomeHandler( UserService userService, CandidateService candidateService ) : IStepHandler
{
    public StepKind Step => StepKind.PreboardingWelcome;
    ...
    public async Task HandleAsync( CallbackQuery callbackQuery, ITelegramBotClient botClient, CancellationToken cancellationToken )
    {
        ...
        await botClient.SendSticker(
            ...
            sticker: StickerIds.PreboardingWelcomeSticker,
            cancellationToken: cancellationToken
        );
        await botClient.SendMessage(
            chatId: callbackQuery.Message.Chat.Id,
            text: PreboardingMessages.PreboardingWelcome,
            replyMarkup: Inline.PreboardingWelcome(),
