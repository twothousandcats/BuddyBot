...
public class NotificationInfoHandler( UserService userService, CandidateService candidateService ) : IStepHandler
{
    public StepKind Step => StepKind.NotificationInfo;
    ...
    public async Task HandleAsync( CallbackQuery callbackQuery, ITelegramBotClient botClient, CancellationToken cancellationToken )
    {
        ...
        await botClient.SendMessage(
            ...
            text: PreboardingMessages.NotificationInfo,
            replyMarkup: Inline.NotificationInfo(),
