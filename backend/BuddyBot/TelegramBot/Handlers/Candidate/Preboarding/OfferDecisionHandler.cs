...
public class OfferDecisionHandler( UserService userService, CandidateService candidateService ) : IStepHandler
{
    public StepKind Step => StepKind.OfferDecision;
    ...
    public async Task HandleAsync( CallbackQuery callbackQuery, ITelegramBotClient botClient, CancellationToken cancellationToken )
    {
        ...
        await botClient.SendMessage(
            ...
            text: PreboardingMessages.OfferDecision,
            replyMarkup: Inline.OfferDecision(),
