...
public class PersonalAreaFaqHandler : ICallbackHandler
{
    public bool CanHandle( string callbackData ) => callbackData == "PersonalAreaFAQ";
    ...
    public async Task HandleAsync( CallbackQuery callbackQuery, ITelegramBotClient botClient, CancellationToken cancellationToken )
    {
        ...
        await botClient.SendMessage(
            ...
            text: PersonalAreaMessages.PersonalAreaFAQ,
            replyMarkup: Inline.PersonalAreaFaq(),
