...
public class FaqPromotionHandler : ICallbackHandler
{
    public bool CanHandle( string callbackData ) => callbackData == "FaqPromotion";
    ...
    public async Task HandleAsync( CallbackQuery callbackQuery, ITelegramBotClient botClient, CancellationToken cancellationToken )
    {
        ...
        await botClient.SendMessage(
            ...
            text: PersonalAreaMessages.FaqPromotion,
