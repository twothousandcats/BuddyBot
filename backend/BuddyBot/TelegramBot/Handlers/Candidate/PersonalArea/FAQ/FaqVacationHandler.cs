...
public class FaqVacationHandler : ICallbackHandler
{
    public bool CanHandle( string callbackData ) => callbackData == "FaqVacation";
    ...
    public async Task HandleAsync( CallbackQuery callbackQuery, ITelegramBotClient botClient, CancellationToken cancellationToken )
    {
        ...
        await botClient.SendMessage(
            ...
            text: PersonalAreaMessages.FaqVacation,
