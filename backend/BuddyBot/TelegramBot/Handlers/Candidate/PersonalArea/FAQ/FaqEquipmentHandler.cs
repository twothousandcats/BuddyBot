...
public class FaqEquipmentHandler : ICallbackHandler
{
    public bool CanHandle( string callbackData ) => callbackData == "FaqEquipment";
    ...
    public async Task HandleAsync( CallbackQuery callbackQuery, ITelegramBotClient botClient, CancellationToken cancellationToken )
    {
        ...
        await botClient.SendMessage(
            ...
            text: PersonalAreaMessages.FaqEquipment,
