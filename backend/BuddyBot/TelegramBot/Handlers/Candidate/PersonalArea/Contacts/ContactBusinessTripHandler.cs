...
public class ContactBusinessTripHandler : ICallbackHandler
{
    public bool CanHandle( string callbackData ) => callbackData == "ContactBusinessTrip";
    ...
    public async Task HandleAsync( CallbackQuery callbackQuery, ITelegramBotClient botClient, CancellationToken cancellationToken )
    {
        ...
        string fullName = "Кристина Фоминых";
        string teamsUrl = "https://teams.microsoft.com/l/chat/0/0?users=kristina.fominykh@travelline.ru";
